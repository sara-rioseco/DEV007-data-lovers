...
describe("dataFunctions", () => {
  ...
  describe("dataFunctions.getPokeByName", () => {
    ...
    it('should return an object for "ivysaur"', () => {
      expect(typeof dataFunctions.getPokeByName(data, "ivysaur")).toBe(
        "object"
      );
    });
    it("should throw Error if called with wrong argument types", () => {
      expect(() => dataFunctions.getPokeByName(5)).toThrow(
  ...
  describe("dataFunctions.getPokeByNumber", () => {
    ...
    it("should throw Error if called with wrong argument types", () => {
      expect(() => dataFunctions.getPokeByNumber(15)).toThrow(
        "Wrong argument types"
      );
    });
  });
  ...
  describe("dataFunctions.getPokeByType", () => {
    ...
    it("should throw Error if called with wrong argument types", () => {
      expect(() => dataFunctions.getPokeByType(15)).toThrow(
        "Wrong argument types"
      );
    });
  });
  ...
  describe("dataFunctions.sortPokeByName", () => {
    ...
    it("should return an object", () => {
      expect(
        typeof dataFunctions.sortPokeByName(data, [
          "bulbasaur",
          "ivysaur",
          "venusaur",
        ])
  ...
  describe("dataFunctions.sortPokeByNum", () => {
    ...
    it("should return an object", () => {
      expect(
        typeof dataFunctions.sortPokeByNum(data, ["001", "002", "003"])
      ).toEqual("object");
    });
  });
  ...
  describe("dataFunctions.getTypeImgs", () => {
    ...
    it("should return a string with both html img elements for a 2 element array", () => {
      expect(typeof dataFunctions.getTypeImgs(["fire", "water"])).toBe(
        "string"
      );
      expect(dataFunctions.getTypeImgs(["fire", "water"])).toBe(
        '<img src="./assets/img/poke-types/fire.jpg" alt="pokemon type fire" class="image type-img"><img src="./assets/img/poke-types/water.jpg" alt="pokemon type water" class="image type-img">'
      );
    });
    it("should return a string with the html img element for a 1 element array", () => {
      ...
      expect(dataFunctions.getTypeImgs(["poison"])).toBe(
        '<img src="./assets/img/poke-types/poison.jpg" alt="pokemon type poison" class="image type-img">'
      );
    });
  });
  ...
  describe("dataFunctions.joinEvolutions", () => {
    ...
    it("should return 'Bulbasaur -> Ivysaur -> Venusaur' for 'Bulbasaur'", async () => {
      expect(dataFunctions.joinEvolutions(data[0])).toBe(
        "Bulbasaur -> Ivysaur -> Venusaur"
      );
    });
    it("should return 'Bulbasaur -> Ivysaur -> Venusaur' for 'Ivysaur'", async () => {
      expect(dataFunctions.joinEvolutions(data[1])).toBe(
        "Bulbasaur -> Ivysaur -> Venusaur"
      );
    });
    it("should return 'Bulbasaur -> Ivysaur -> Venusaur' for 'Venusaur'", async () => {
      expect(dataFunctions.joinEvolutions(data[2])).toBe(
        "Bulbasaur -> Ivysaur -> Venusaur"
      );
    });
    it("should return 'Celebi' for 'Celebi'", async () => {
      expect(dataFunctions.joinEvolutions(data[3])).toBe("Celebi");
    });
  });
